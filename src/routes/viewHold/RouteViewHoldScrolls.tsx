...
import type { HoldScroll } from "../../data/datatypes/HoldRoom";
...
const Columns: SortableTableColumn<HoldScroll>[] = [
	{
		...
		sort: (isAsc, left, right) =>
			sortCompareRefs(isAsc, left.$scrollRef, right.$scrollRef),
		filter: (scroll, filter) =>
			filterString(holdRefToSortableString(scroll.$scrollRef), filter),
		filterDebounce: 500,
	},
	{
		id: "text",
