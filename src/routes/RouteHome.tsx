...
export default function RouteHome() {
	return (
		<div className="container mt-5 homepage-cards">
			<section className="hero is-primary mb-5">
				<div className="hero-body">
					<p className="title">Get started quickly?</p>
					<p className="subtitle">
						Just click "Load Hold" in the top-right corner. The rest is,
			...
			<div className="columns">
				<div className="column">
					...
					>
						<p>
							Speech, room names, data names, and more. All the text can be
							edited.
						</p>
					</Card>
				</div>
				<div className="column">
					<Card
						icon="fa-database"
						title="Edit Images & Audio"
						subtitle="Preview and replace"
					>
						<p>
							Audio and image files can be easily updated in place without
							having to worry about scripts breaking.
						</p>
					</Card>
				</div>
				<div className="column">
					<Card
						icon="fa-file-shield"
						title="Auto Backups"
						subtitle="Added holds & changes"
					>
						<p>
							All the changes you make are automatically stored in your
							browser's storage so that you don't accidentally lose your
							changes.
						</p>
			...
			<div className="columns">
				<div className="column">
					<Card
						...
						title="Open Source"
						subtitle="See it on github"
					>
						<p>
							If you somehow feel inclined to check the codebase you can find it{" "}
							<a href="https://github.com/EvidentlyCube/drod-hold-tools">
								here
							</a>
							.
						</p>
				...
				<div className="column">
					<Card
						...
						subtitle="0% Enterprise"
					>
						<p>
							I know it looks like a generic webapp/webtool/webpage made for
							profit or something. I am not good with web design, okay?
						</p>
					</Card>
				</div>
				<div className="column">
					<Card icon="fa-newspaper" title="Roadmap" subtitle="And changlog">
						<p>
							Below you can find the list of planned things, changelog and
							stuff.
						</p>
					</Card>
				</div>
...
function Feat() {
	return (
		<span className="icon has-text-success" title="New Feature or Improvement">
...
function Bug() {
	return (
		<span className="icon has-text-danger" title="Bugfix">
