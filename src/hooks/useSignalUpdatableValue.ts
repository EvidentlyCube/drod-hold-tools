...
import type {
	SignalUpdatableChangeData,
	SignalUpdatableValue,
} from "../utils/SignalUpdatableValue";

export function useSignalUpdatableValue<T>(
...
export function useSignalUpdatableValue<T>(
	...
	useEffect(
		() => updatableValue.onChange.addForHook(refresh),
		[updatableValue, refresh],
	);
